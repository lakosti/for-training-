...
// 1. for() -- перебір якихось елементів або повторення якоїсь операції певну кількість разів for завжди ініціалізується let // // ініціалізація /умова/ поствираз(ітерація)
